  ...
  return (
    ...
    >
      ...
      <p className="max-w-2xl mx-auto text-center font-dubai-reg mb-6">
        Coming from Spain? You're in for a tropical adventure! Here's everything you need to know to make the most of your trip to the Philippines — especially around the wedding in Cebu City on <strong>May 1st, 2026</strong>.
      </p>
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div>
          <h3 className="text-2xl font-dubai-reg mb-2">Hotels/Accomodations</h3>
        ...
        <div>
          <h3 className="text-2xl font-dubai-reg mb-2">Things to Consider
          </h3>
          <ul className="list-disc list-inside font-dubai-reg mt-2">
